...
export default class Page extends Component {
    ...
    setEventListeners() {
        ...
        this.filters.select.node.addEventListener('change', () => {
            this.sort();
            this.winecards.rerender(LocalStorage.getLocalStorage(localStorageKeys.onPage));
    ...
    sort() {
        ...
        if (item === 'ByPriceUp') {
            this.filterSettings.sortPriceUp(LocalStorage.getLocalStorage(localStorageKeys.onPage) || goods);
        }
        if (item === 'ByPriceDown') {
            this.filterSettings.sortPriceDown(LocalStorage.getLocalStorage(localStorageKeys.onPage) || goods);
        } 
    }
}
