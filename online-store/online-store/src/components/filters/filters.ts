...
export class Filters extends Component {
    ...
    constructor(parentNode?: HTMLElement) {
        ...
        this.countryFilter = new Component(this.filtersContainer.node, 'div', 'country-filters');
        this.colorFilter = new Component(this.filtersContainer.node, 'div', 'color-filters');
        ...
        this.resetFilters = new Component(this.node, 'button', 'reset-filters btn', 'Сбросить фильтры');
        this.clearHistory = new Component(this.node, 'button', 'reset-filters reset btn', 'Очистить историю');
    }
